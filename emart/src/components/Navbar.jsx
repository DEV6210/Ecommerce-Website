        ...
        <div className="sticky-top" id="navbar">
            <div className="nav container-fluid navbar-scroll">
                ...
                <ul className="nav_link_option">
                    ...
                    <NavLink to='/signup' className='nav_link signup'>
                        <i class="fa-solid fa-user-plus"></i>
                        <span className="nav_title">Signup</span>
                    </NavLink>
                    <NavLink to='/login' className='nav_link login'>
    ...
    return (
        <>
            <div className="BottomNav">
                <NavLink className='bottomnav' style={cssStyle1} to={'/'}>
                ...
                <NavLink className='bottomnav' style={cssStyle2} to={'/about'}>
                ...
                <NavLink className='bottomnav' style={cssStyle3} to={'/catagories'}>
                ...
                <NavLink className='bottomnav' style={cssStyle4} to={'/cart'}>
                ...
                <NavLink className='bottomnav' style={cssStyle5} to={'/login'}>
